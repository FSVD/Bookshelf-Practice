...
function authorController() {
    ...
    this.selectAuthor = function (id, res) {
        ...
        .then(result => {
            //console.log("Rusult sended by controller")
            ...
            res.status(200).render('error', { errorTitle: 'Author not selected', errorMessage: err.errorInfo.message });
            //res.status(500).json({errorInfo: {data:err, message:err.message}, propagatedBy: {module: 'authorController', function: 'selectAuthor'}});
        })
    }
    ...
    this.insertAuthor = function (req, res) {
        ...
        .then(result => {
            ...
            res.status(500).json({errorInfo: {data:err, message:err.message}, propagatedBy: {module: 'authorController', function: 'insertAuthor'}});
        })
    }
    ...
    this.updateAuthor = function (req, res) {
        ...
        .then(result => {
            ...
            res.status(500).json({errorInfo: {data:err, message:err.message}, propagatedBy: {module: 'authorController', function: 'updateAuthor'}});
        })
    }
    ...
    this.deleteAuthor = function (id, res) {
        ...
        .then(result => {
            ...
            res.status(500).json({errorInfo: {data:err, message:err.message}, propagatedBy: {module: 'authorController', function: 'deleteAuthor'}});
        })   
    }
    ...
    this.selectAuthorBooks = function (id, res) {
        ...
        .then(result => {
            ...
            res.status(500).json({errorInfo: {data:err, message:err.message}, propagatedBy: {module: 'authorController', function: 'selectAuthorBooks'}});
        })   
    }
}
