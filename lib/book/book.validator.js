...
function bookValidator() {
    ...
    this.validateUpdateBookParams = function(req, res) {
        try {
            return this.validateSelectBookParams(req.body.id, res)
                .then(result => {
                    return this.validateInsertBookParams(req, res)
                    .then(result => {
                        return Promise.resolve(req);
                    })
                })
    ...
    this.validateDeleteBookParams = function(id, res) {
        return this.validateSelectBookParams(id, res);
    }

    this.validateSelectBookGenresParams = function(id, res) {
        return this.validateSelectBookParams(id, res);
    }
